...
The wiki has information that is a bit more detailed or less common, but may be useful: https://github.com/usalko/sm/wiki
...
in the main directory. This will generate the sm (or
`sm.exe`, or `sm.app`) application in the src subdirectory.
...
git clone https://github.com/usalko/sm
cd sm
...
This should complete without errors, and `sm` should now be launch-able from the command line.
...
This should complete without errors, giving you an executable file called `sm`. Done. :)

> Also, we have a CI workflow for Ubuntu, you can check it out [here](https://github.com/usalko/sm/blob/master/.github/workflows/build-ubuntu.yml)
...
Then it's just a matter of getting the source:
    ...
    $ git clone https://github.com/usalko/sm.git
...
> Also, we have a CI workflow for macOS, you can check it out [here](https://github.com/usalko/sm/blob/master/.github/workflows/build-macos.yml)
...
&nbsp; &nbsp; https://github.com/usalko/sm/wiki/Setting-up-a-Win64-development-environment-for-DB4S
...
Now cd into your sm source directory and create a build directory
...
> Also, we have a CI workflow for Windows, you can check it out [here](https://github.com/usalko/sm/blob/master/.github/workflows/build-windows.yml)
...
it can be passed when running `cmake` to configure sm,
